                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex gap-2">
                          <button
                            ...
                            onClick={() => handleViewStation(station._id || station.id)}
                          >
                            View Details
                          </button>
                          <button
                            ...
                            onClick={() => handleUpdateStation(station._id || station.id)}
                          >
                            Update
                          </button>
                        </div>
                        <button
                          ...
                          onClick={() => handleToggleStatus(station._id || station.id, station.isActive)}
                        >
